...
MyPage {
        ...
        function post(vcode, vcodeMd5){
            ...
            if (page.state == ""){
                ...
                if (tbsettings.shareLocation && positionSource.valid){
                    opt.lbs = positionSource.latitude+"%2C"+positionSource.longitude;
                }
    ...
    Item {
        ...
        Row {
            ...
            ToolButton {
                iconSource: "gfx/btn_insert_at_res.png";
                onClicked: {
                    pageStack.push(Qt.resolvedUrl("SelectFriendPage.qml"), {caller: page});
                }
            }
            ToolButton {
                iconSource: "gfx/btn_insert_pics_res.png";
    ...
    states: [
        State {
            ...
            PropertyChanges {
                target: contentArea;
                anchors.top: app.inPortrait ? viewHeader.bottom : page.top;
            }
        },
        State {
            name: "weipost";
