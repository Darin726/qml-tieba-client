...
Dialog {
    ...
    platformStyle: DialogStyle { leftMargin: 33; rightMargin: 33; }

    title: Text {
        id: titleText;
        text: qsTr("Tieba Infomation");
        color: "white";
        font {
            bold: true;
            pixelSize: constant.fontSizeXXLarge;
        }
    }
    ...
    content: Item {
        ...
        ? visualParent.height * 0.87 - titleText.height - constant.paddingLarge - 50
        : root.parent
          ? root.parent.height * 0.87 - titleText.height - constant.paddingLarge - 50
          : 350
        height: Math.min(maxListViewHeight, contentCol.height);
