...
MyPage {
    ...
    tools: ToolBarLayout {
        ...
        ToolButtonWithTip {
            property string sfx: tbsettings.whiteTheme ? "_inverted.svg" : ".svg";
            toolTipText: isEdit ? qsTr("OK") : qsTr("Edit");
            iconSource: isEdit ? "gfx/ok"+sfx : "gfx/edit"+sfx;
            ...
            ListItem {
                ...
                Row {
                    ...
                    Image {
                        ...
                        function setSource(){
                            if (modelData.userId == Script.uid){
                                icon.source = root.platformInverted ? "gfx/ok_inverted.svg" : "gfx/ok.svg";
                            } else {
                                icon.source = "";
                            }
                        }
