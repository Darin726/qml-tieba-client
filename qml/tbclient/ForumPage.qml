...
MyPage {
    ...
    tools: ToolBarLayout {
        ...
        ToolButtonWithTip {
            ...
            iconSource: platformInverted ? "gfx/switch_windows_inverted.svg" : "gfx/switch_windows.svg";
    ...
    ScrollDecorator { platformInverted: tbsettings.whiteTheme; flickableItem: view; }
}
