...
MyPage {
    ...
    ToolBarLayout {
        ...
        ToolButtonWithTip {
            ...
            iconSource: platformInverted ? "gfx/tb_close_stop_inverted.svg" : "gfx/tb_close_stop.svg";
    ...
    Item {
        ...
        Button {
            ...
            iconSource: platformInverted ? "gfx/btn_insert_face_nor.png":
                                           "gfx/btn_insert_face_res.png";
            onClicked: {
